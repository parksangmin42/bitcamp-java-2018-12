...
// 4) => Command 변경
//    => ServletRequest와 SetvletResponse를 
...
//    - OS에 설치한 톰캣 서버의 경로를 등록
// 2) 웹 어플리케이션을 테스트 할 때 사용할 톰캣 배치 폴더 생성
//    - 'Servers' 뷰 선택
//    - New/Server 메뉴 클릭
...
//    - 생성된 배치 폴더의 경로
//      이클립스워크스페이스폴더/.metadata/.plugins/org....wst.server.core/
// 3) 웹 어플리케이션을 테스트 용으로 만든 배치 폴더에 배포한다.
//    - 'gradle build'를 실행할 필요가 없다.
//    - 'Servers' 뷰 선택
//    - 테스트 서버에 대해 컨테스트 메뉴 출력
